...
import hu.nova.blu3berry.kraft.processor.enummapping.generator.getEnumEntries

/**
 * Scanner for finding and processing @EnumMap annotations.
 *
 * This class scans the codebase for classes annotated with @EnumMap and
 * builds EnumMappingDescriptor objects for each valid mapping.
 */
class EnumMapperScanner(
