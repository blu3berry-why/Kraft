 ...
 *   classes share the same property name. Use [@MapIgnoreField][hu.nova.blu3berry.kraft.config.MapIgnoreField]
 *   inside a [@MapConfig][hu.nova.blu3berry.kraft.config.MapConfig] for cross-name ignores.
 *
 * Example:
 * ```
